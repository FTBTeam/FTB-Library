...
public class ColorSelectorPanel extends ModalPanel {
    ...
    private final EditableColor config;
    ...
    public static ColorSelectorPanel popupAtMouse(BaseScreen gui, EditableColor config, ConfigCallback callback) {
    ...
    private void setColor(Color4I newColor) {
        if (config.updateValue(newColor)) {
