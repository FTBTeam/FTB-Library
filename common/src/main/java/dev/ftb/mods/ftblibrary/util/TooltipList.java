...
//
//		buffer.addVertex(mat, right, top, 0).setColor(startRed, startGreen, startBlue, startAlpha);
//		buffer.addVertex(mat, left, top, 0).setColor(startRed, startGreen, startBlue, startAlpha);
//		buffer.addVertex(mat, left, bottom, 0).setColor(endRed, endGreen, endBlue, endAlpha);
//		buffer.addVertex(mat, right, bottom, 0).setColor(endRed, endGreen, endBlue, endAlpha);
//	}
}
