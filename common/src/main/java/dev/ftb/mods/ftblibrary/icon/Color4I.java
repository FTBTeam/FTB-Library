...
public class Color4I extends Icon<Color4I> {
    ...
    public static Color4I parse(@Nullable String s) {
        if (s == null || s.isEmpty()) {
            return empty();
    ...
    public static Color4I rgba(int red, int green, int blue, int alpha) {
        red = red & 0xff;
        green = green & 0xff;
        blue = blue & 0xff;
        alpha = alpha & 0xff;
        ...
        if (alpha == 0) {
            ...
            return BLACK_A[alpha];
        } else if (red == 255 && green == 255 && blue == 255) {
            return WHITE_A[alpha];
        }

        return new Color4I(red, green, blue, alpha);
    }
    ...
    @Override
    public IconRenderer<Color4I> getRenderer() {
        return Color4IRenderer.INSTANCE;
    }
    ...
    @Override
    public Color4I withColor(Color4I color) {
        return color;
    }
