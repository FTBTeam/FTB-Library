 ...
 */
public class GuiContainerWrapper extends AbstractContainerScreen implements IGuiWrapper
{
	private final GuiBase wrappedGui;
	private boolean drawSlots = true;
	private final TooltipList tooltipList = new TooltipList();

	public GuiContainerWrapper(GuiBase g, AbstractContainerMenu c, Inventory playerInventory, Component title)
	{
