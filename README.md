...
Core library for all other FTB mods. Also adds a few utility commands, of particular use may be `/ftblibrary nbtedit`, an interactive NBT browser and editor.
