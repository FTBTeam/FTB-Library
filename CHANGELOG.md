...
### Changed
* Duplicate keymap category registration (when done via FTB Library platform abstraction API) is no longer fatal
  * A warning will be logged and the duplicate registration attempt ignored
